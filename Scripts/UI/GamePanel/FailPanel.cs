...
/// <summary>
/// 失败面板（View 层）。
/// 监听 <see cref="E_EventType.Battle_PlayerDied"/> 事件后显示自身，
...
public class FailPanel : BaseMgrMono<FailPanel>
{
    ...
    {
        EventCenter.Instance.AddEventListener(E_EventType.Battle_PlayerDied, Show);
    }

    private void OnDisable()
    {
        EventCenter.Instance.RemoveEventListener(E_EventType.Battle_PlayerDied, Show);
    }
